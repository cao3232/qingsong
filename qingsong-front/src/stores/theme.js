  ...
  const skinPresets = ref([
    ...
    },
    {
      ...
      vars: {
        ...
        '--chat-inset-light': 'transparent',
        '--chat-titlebar-start': '#e85d75',
        '--chat-titlebar-end': '#f08a68',
        '--chat-titlebar-text': '#ffffff',
        ...
        '--chat-accent': '#d94f70',
        '--chat-accent-hover': '#bd365a',
        '--chat-text': '#49333a',
        '--chat-text-muted': '#98747d',
        '--chat-text-on-accent': '#ffffff',
        '--chat-active-title': '#ffffff',
        '--chat-active-muted': 'rgba(255, 255, 255, 0.82)',
        '--chat-danger': '#dc2626',
        ...
        '--chat-user-bubble-bg': 'linear-gradient(135deg, #ef7183, #e8655a)',
        '--chat-user-bubble-bg-hover': 'linear-gradient(135deg, #e85d75, #dc554c)',
        '--chat-user-bubble-text': '#ffffff',
        '--chat-user-bubble-border': 'transparent',
        '--chat-user-bubble-border-hover': 'transparent',
        ...
        '--chat-send-bg': 'linear-gradient(135deg, #ef7183, #e8655a)',
        '--chat-send-bg-hover': 'linear-gradient(135deg, #e85d75, #dc554c)'
      }
    },
    {
      name: 'ink',
